#@Author=Arnaud NG
#This script analyses SARS-CoV-2 evolution in epitopes during the first wave of the COVID-19 pandemic
...
df_variants_NCBI_SRA_amplicon <- readRDS(paste0(output_workspace,"df_variants_SRA_amplicon_first_wave.rds"))
...
#save Rsession
library("session")
save.session(file = paste0(output_workspace,"FIRST_WAVE_high_confidence_epitope_analysis_RSession.Rda"))
